...
(@) Detect if the book is the second book in a series

```{r, eval=FALSE}
str_???(bestsellers %>% pull(???), pattern = “???”)
```


(@) Detect if the book is the third or fourth book in a series
...
Find the stringr cheatsheet [here](https://www.rstudio.com/resources/cheatsheets/):
